...
(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		init: function () {
			...
			this.$elem.css( 'padding-right',
				'20px' ).before( "<span class='form__indicator'><span></span><span></span><span></span><span></span><ul class='form__indicator--popover'><li>Must be at least 8 characters.</li><li>Good passwords are hard to guess. Try using a multi-word phrase, uncommon words, numbers or symbols.</li></ul></span>" );
